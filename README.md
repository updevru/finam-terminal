...
- 🏦 Вкладка «Индекс»: состав Индекса МосБиржи (`GetConstituents`) с ценой, изменением за сессию и весом, отсортированный по весу. Котировки идут по уже открытому стриму, пока вкладка активна; из любой строки — `Enter` в профиль, `A` в модалку заявки.
