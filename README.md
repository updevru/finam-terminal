...
При первом запуске, если API токен не найден, приложение автоматически откроет **экран настройки**.
...
- 🎮 **Открыть демо-счет:** [finam.ru/landings/demoschet-bonus/](https://www.finam.ru/landings/demoschet-bonus/)
- 🔑 **Создать токен** (после входа в кабинет): [tradeapi.finam.ru/docs/tokens/](https://tradeapi.finam.ru/docs/tokens/)
...
- 🖥️ Удобный консольный интерфейс с поддержкой мыши.
