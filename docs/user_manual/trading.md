...
> **[Скриншот]**: Модальное окно заявки с типом «Limit». Видно дополнительное поле Limit Price, предзаполненное текущей ценой.
...
> **[Скриншот]**: Модальное окно заявки с типом «Stop-Loss». Видно дополнительное поле Stop Price.
...
> **[Скриншот]**: Модальное окно заявки с типом «Take-Profit». Видно дополнительное поле TP Price.
...
> **[Скриншот]**: Модальное окно заявки с типом «SL+TP». Видны два дополнительных поля: SL Price и TP Price.
...
> **[Скриншот]**: Модальное окно закрытия позиции. Поля предзаполнены: инструмент, количество (равно текущей позиции), направление (противоположное позиции).
...
> **[Скриншот]**: Модальное окно редактирования заявки. Заголовок «Modify Order — [название инструмента]». Все поля предзаполнены текущими параметрами заявки.
...
> **[Скриншот]**: Диалог подтверждения отмены заявки. Текст вопроса и две кнопки: «Yes» и «No».
