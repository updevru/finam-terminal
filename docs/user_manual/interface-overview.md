...
Занимает большую часть экрана. Содержит четыре вкладки, между которыми можно переключаться:

- **Позиции** — текущие открытые позиции в портфеле
- **История** — журнал совершённых сделок
- **Заявки** — активные и исполненные ордера
- **Индекс** — состав Индекса МосБиржи с ценами в реальном времени
...
Вкладки переключаются циклически: после «Индекс» — снова «Позиции».
