...
## Phase 2: Новый формат ключей — онбординг и документация [checkpoint: a7d5309]
...
- [x] Task: (Ручной смоук, вариант B) Запуск приложения с реальным ключом `tapi_sk_...` — подтвердить вход, загрузку счетов и приход новых JWT по стриму; проверить, что старый длинный ключ тоже работает (confirmed by user 2026-07-12: "все хорошо")
