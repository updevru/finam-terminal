...
## Phase 1: Конвертация временных меток в API клиенте [checkpoint: b5540e3]
...
- [x] Task: Ручная проверка — запустить приложение и убедиться, что время совпадает с системным `26e7c71`
